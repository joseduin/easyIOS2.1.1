...
class ViewController: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    override func viewDidLoad() {
        ...
        let swipeRight = UIScreenEdgePanGestureRecognizer(target: self, action: #selector(ViewController.swipeRightSlider(_:)))
        //swipeRight.direction = .right
        swipeRight.edges = .left
        view.addGestureRecognizer(swipeRight)
        
        let swipeLeft = UISwipeGestureRecognizer(target: self, action: #selector(ViewController.swipeLeftSlider(_:)))
